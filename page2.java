...
class page2_two extends JPanel{
	...
	public static JButton[] setno1=new JButton[16];
     public page2_two(){
		...
		//버튼 당 쓸 이미지 
		  ImageIcon drink1=new ImageIcon("C:\\Users\\AhnSeoYeon\\Desktop\\workspace\\ch09\\src\\ch09\\"+setmenu[i]+".PNG");
          ...
          setno1[i].addMouseListener(listener);
...
class page2_three extends JPanel{
    ...
    public page2_three(){
		...
		//버튼 당 쓸 이미지 
		  ImageIcon drink1=new ImageIcon("C:\\Users\\AhnSeoYeon\\Desktop\\workspace\\ch09\\src\\ch09\\"+drinkmenu[i]+".PNG");
...
class buylist extends JPanel{
	...
	public buylist() {
		...
		JButton deleteitem=new JButton("삭제");
		add(additem);
		add(deleteitem);
		setVisible(true);
...
public class page2 extends JFrame {
	...
	class page2_one extends JPanel{
		...
		public page2_one(){
			...
			//버튼 당 쓸 이미지 
			  ImageIcon burger1=new ImageIcon("C:\\Users\\AhnSeoYeon\\Desktop\\workspace\\ch09\\src\\ch09\\"+burgermenu[i]+".PNG");
	...
	public page2() {
		...
		//two.setPreferredSize(new Dimension(500, 300));
		page2_three three=new page2_three();
		//three.setPreferredSize(new Dimension(500, 300));
		...
		//btns.add("East",addBtn);
		//btns.add("West",delBtn);
		...
		//split.setRightComponent(addBtn);
		
		//split.setRightComponent(cart);
		...
		JLabel kiosk=new JLabel();
		
		kiosk.setBounds(294,850,700,50);   //x,y, 가로,세로
